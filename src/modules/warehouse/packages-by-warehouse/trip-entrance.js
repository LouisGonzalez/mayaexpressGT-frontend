...
function TripEntrance(props) {
  ...
  const goTripEntrance = async () => {
    if (date !== undefined) {
      await warehouseService.tripEntrance({
      ...
      setGeneralMessage("Viaje recibido con exito");
      toggleSnackbar();
    } else {
